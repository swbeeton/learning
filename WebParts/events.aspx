	...
	<script id="event_list_tmpl" type="x-tmpl-mustache">
		...
		{{#events}}
			...
			<div class="event_listing">			
				<h1><a href="/TASites/LearningHub/V2_Redevelopment/Core/WebParts/event.aspx?EventID={{eventId}}" class="resource-image">{{title}}</a></h1>
				<p>{{short_description}}</p>
				<p><strong>{{site}}</strong></p>
				<p><strong>{{room}}</strong></p>
				<p><strong>{{room}}</strong></p>
				<p><strong>{{room}}</strong></p>
				<a href="/TASites/LearningHub/V2_Redevelopment/Core/WebParts/event.aspx?EventID={{eventId}}">More Information</a>
			</div>
